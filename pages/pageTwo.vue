...
const set = () => {
  ...
  secureThttpFsameSiteTpath.value = "secure: true, samesite: true, httpOnly: true, path: '/";
  secureTsameSiteTpathMaxAge3600.value = "secure: true, samesite: true, path: '/', maxAge: 3600"
};
const remove = () => {
  cookie.value = null;
...
<template>
  <div>
    ...
    <p><b>secureTrue, httpOnlyFalse, sameSiteTrue, path='/'</b>: {{ secureThttpFsameSiteTpath }}</p>
    <p><b>secureTrue, sameSiteTrue, path='/', MaxAge3600</b>: {{ secureTsameSiteTpathMaxAge3600 }}</p>
    <hr />
